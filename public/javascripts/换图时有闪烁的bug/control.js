$(Document).ready(function() {
    ...
    $.get("/index",function(data) {
            ...
            $('#myCarousel').hide().addClass('animated zoomIn').show();
            var state = {
                url:"/index"
            }
            history.pushState(state,document.title,"/index");
            console.log(history.state.url);
        });
    //index===========================================================================
    $("#index").click(function() {
        $(".bodyPart").children().fadeOut(500, function() {
            $.get("/index",function(data) {
    ...
    $('#coding').click(function() {
        ...
        $(".bodyPart").children().fadeOut(300, function() {
            $.get("/coding",function(data) {
                ...
                $(".bodyPart").children().remove();
                $(".bodyPart").html(data);
                $('.coding').hide().fadeIn(500);
                var state = {
                    url:"/coding",
                }
                history.pushState(state,document.title,"/coding");
            });
        })
    ...
    $(Document).on("click","#login",function() {
        ...
        $(".bodyPart").children().fadeOut(300, function() {
            $.get("/login",function(data) {
                ...
                $('.login').hide().addClass('animated bounceInDown').show();
            });
        })
    ...
    $(Document).on("click","#reg",function() {
        ...
        $(".bodyPart").children().fadeOut(300, function() {
            $.get("/reg",function(data) {
                ...
                $('.reg').hide().addClass('animated bounceInDown').show();
            });
        })
    ...
    $(Document).on("click", '#postArticle', function() {
        $(".bodyPart").children().fadeOut(300, function() {
            $.get("/postArticle", function(data) {
                ...
                $(".bodyPart").children().remove();
                $(".bodyPart").html(data);
                $('.articlePost').hide().addClass('animated bounceInDown').show();
                //根据视窗高度自动使文字高度在视窗居中；
                var height = $(window).height()/5 + "px";
    ...
    $(Document).on("click", '#headPortrait', function() {
        $(".bodyPart").children().fadeOut(300, function() {
            $.get("/headPortrait", function(data) {
                ...
                history.pushState(state,document.title,"/headPortrait");
    ...
    $('#life').click(function() {
        ...
        $(".bodyPart").children().fadeOut(300, function() {
            $.get("/life",function(data) {
                ...
                history.pushState(state,document.title,"/life");
            });
        })
    ...
    $('#novel').click(function() {
        $(".bodyPart").children().fadeOut(300, function() {
            ...
            $.get("/novel",function(data) {
                ...
                history.pushState(state,document.title,"/novel");
            });
        })
    });
    //novel目录点击翻页事件=====================================================================
        ...
        $(".bodyPart").children().fadeOut(300, function() {
            ...
            if (history.state.url == "/article") {
                ...
                $(".bodyPart").load(history.state.url,{"articleId":history.state.articleId},function() {
                    $(".bodyPart").children().hide().addClass('animated zoomIn').show();
                });
            }
            $(".bodyPart").load(history.state.url,function() {
                $(".bodyPart").children().hide().addClass('animated zoomIn').show();
